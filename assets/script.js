...
const SCRIPT_URL =
    "https://script.google.com/macros/s/AKfycbzFA37OHUWQOPXDhbuKbtKc5r-feeZZqsZDLG8ajMBwt97-jfzZhjyekejfPd0bufT-FA/exec";
// Biến toàn cục
let products = [];
...
//         const data = await fetchFromAPI("getProducts");
